...
parser.add_argument('--sample_neighbor', action='store_false', default=True, help='whether sample neighbors')
parser.add_argument('--sparse_attention', action='store_false', default=True, help='whether use sparse attention')
parser.add_argument('--structure_learning', action='store_false', default=True, help='whether perform structure learning')
