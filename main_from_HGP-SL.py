...
parser.add_argument('--sample_neighbor', type=bool, action='store_false', default=True, help='whether sample neighbors')
parser.add_argument('--sparse_attention', type=bool, action='store_false', default=True, help='whether use sparse attention')
parser.add_argument('--structure_learning', type=bool, action='store_false', default=True, help='whether perform structure learning')
...
def train():
    ...
    for epoch in range(args.epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            out = model(data, args.negative_num, None, None)
